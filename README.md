<div align="center">
  <img src="docs/source/_static/img/PlanoTagline.svg" alt="Plano Logo" width="35%" height=auto style="margin-bottom: 5px;">

<h3 style="margin: 5px 0 10px 0; border: none;">The AI-native proxy server and data plane for agentic apps</h3>
...
<p style="max-width: 900px; margin: 10px auto; text-align: left;">Open-source infrastructure layer for agent routing, orchestration & guardrails, decoupling delivery from business logic.</p>
