...
<p style="font-size: 1.3em; font-weight: 600; margin: 5px 0;">The AI-native proxy server and data plane for agentic apps.</p>
...
<p style="max-width: 900px; margin: 20px auto; text-align: left;">Open-source infrastructure layer for agent routing, orchestration & guardrails, decoupling delivery from business logic.</p>
